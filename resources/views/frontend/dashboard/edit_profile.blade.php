                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no_image 2.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="100">
                                                        </div>
                                                    </div>
