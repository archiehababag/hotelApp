            ...
            <div class="row">
                        ...
                        <div class="card-body">
                              <div class="billing-details">
                                    ...
                                    <div style="display: flex">
                                          <img style="height:100px; width:120px;object-fit: cover" src="{{ (!empty($room->image) ? asset('upload/room_images/'.$room->image) : asset('upload/no_image 2.jpg')) }}" alt="Images" alt="Images">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="payment-box">
                        ...
                        <button type="submit" class="order-btn" id="myButton">Process Booking</button>
