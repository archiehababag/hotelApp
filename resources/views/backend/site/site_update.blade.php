...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Update Site Page</div>
            <div class="ps-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            ...
                                            <img src="{{ (!empty($site->logo) ? asset($site->logo) : asset('/upload/no_image 2.jpg')) }}" alt="" class="mt-2" style="width:100px; height:100px">
                                        </div>
                                    </div>
