...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Roles in Permission Page</div>
            <div class="ps-3">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
							<div class="card-body p-4">
								...
								<form action="{{ route('admin.role.update', $role->id) }}" method="post" class="row g-3">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            ...
                                            @endphp
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="CheckDefault" {{ App\Models\User::roleHasPermissions($role,  $permissions) ? 'checked' : '' }}>
