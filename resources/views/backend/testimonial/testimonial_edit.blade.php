...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Testimonial Page</div>
            <div class="ps-3">
                            ...
                            <form id="myForm" action="{{ route('testimonial.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="message" class="form-control" id="input11" placeholder="Write message here..." rows="3">{{ $testimonial->message }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ asset($testimonial->image) }}" alt="" class="rounded-circle p-1 bg-primary" width="80">
                                        </div>
                                    </div>
                                    <div class="row">
