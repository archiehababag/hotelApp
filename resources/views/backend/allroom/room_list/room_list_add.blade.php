...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Add Rooms Page</div>
            <div class="ps-3">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
							<div class="card-body p-4">
								...
								<form action="{{ route('room.list.store') }}" class="row g-3" method="POST">
                                    @csrf
									<div class="col-md-4">
                                    ...
                                    <h3 class="mt-4 mb-4 text-center">Customer Information</h3>

									<div class="col-md-4">
										<label for="input5" class="form-label">Name</label>
										<input type="name" name="name" class="form-control" id="input5" value="{{ old('name') }}">
									</div>
                                    <div class="col-md-4">
										<label for="input5" class="form-label">Email</label>
										<input type="email" name="email" class="form-control" id="input5" value="{{ old('email') }}">
									</div>
                                    <div class="col-md-4">
										<label for="input5" class="form-label">Phone</label>
										<input type="text" name="phone" class="form-control" id="input5" value="{{ old('phone') }}">
									</div>
                                    <div class="col-md-4">
