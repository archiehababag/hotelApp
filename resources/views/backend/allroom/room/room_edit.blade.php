                        ...
                        <div class="tab-content py-3">
                                ...
                                <div class="col-xl-12 mx-auto">
                                    <div class="card">
                                        <div class="card-body p-4">
                                            ...
                                            <form class="row g-3" action="{{ route('room.update', $editData->id) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-md-4">
                                                    <label for="input1" class="form-label">Room Type Name</label>
                                                    <input type="text" name="room_type_id" class="form-control" id="input1" value="{{ $editData['roomType']['name'] }}">
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <img id="showImage" src="{{ (!empty($editData->image)) ? url('upload/room_images/'.$editData->image) : url('upload/no_image.jpg') }}" alt="" class="bg-primary" width="70" height="50">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="input4" class="form-label">Gallery Image</label>
                                                    <input type="file" name="multi_image[]" class="form-control" multiple id="multiImg" accept="image/jpeg, image/jpg, image/gif, image/png"><br>

                                                    @foreach ($multiImages as $item)
                                                        <img src="{{ (!empty($item->multi_image)) ? url('upload/room_images/multi_images/'.$item->multi_image) : url('upload/no_image.jpg') }}" alt="" class="bg-primary" width="70">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="input2" class="form-label">Room Size</label>
                            ...
                            <div class="tab-pane fade" id="primaryprofile" role="tabpanel">
                                <div class="col-xl-12 mx-auto">
                                    <div class="card p-4">
                                        <div class="card-body">
                                            <a class="card-title btn btn-primary float-right" onclick="addRoomNumber()" id="addRoomNumber">
                                                <i class="lni lni-plus"> Add New</i>
                                            </a>
                                        </div>
                                        <div class="roomNoHide" id="roomNoHide">
                                            <form action="{{ route('room.number.store', $editData->id) }}" method="post" >
                                                @csrf
                                                ...
                                                @foreach ($roomNumbers as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('room.number.delete', $item->id) }}" class="btn btn-danger px-3 radius-30" id="delete">Delete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
