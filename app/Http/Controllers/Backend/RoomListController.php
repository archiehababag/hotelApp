...
class RoomListController extends Controller
{
    public function RoomListView()
    {
        ...
        return view('backend.allroom.room_list.room_list_view', compact('room_number_list'));
    } // End Method

    public function RoomListAdd()
    {
        $roomType = RoomType::all();
        return view('backend.allroom.room_list.room_list_add', compact('roomType'));
    ...
    public function RoomListStore(Request $request)
    {
       if ($request->check_in == $request->check_out) {
            ...
            $notification = array(
                'message' => 'Check In date cannot be the same as Check Out Date',
                'alert-type' => 'error'
            );
       ...
       if ($request->available_room < $request->number_of_rooms) {
            ...
            $notification = array(
                'message' => 'We do not have enough rooms available',
                'alert-type' => 'error'
            );
       ...
       if ($room->room_capacity < $request->number_of_person) {
            ...
            $notification = array(
                'message' => 'Number of Guest exceeds the Room Capacity',
                'alert-type' => 'error'
            );
