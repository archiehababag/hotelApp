...
class BookingController extends Controller
{
    ...
    public function BookingStore(Request $request)
    {
        ...
        if ($request->available_room < $request->number_of_rooms) {
            ...
            $notification = array(
                'message' => 'Requested number of rooms is more than the Available Rooms currently',
                'alert-type' => 'error'
            );
    ...
    public function BookingDetailsUpdate(Request $request, $id)
    {
        if ($request->available_room < $request->number_of_rooms) {

            $notification = array(
                'message' => 'Your selection has exceeded the number of rooms available',
                'alert-type' => 'error'
            );
    ...
    public function AssignRoomDelete($id)
    {
        ...
        $notification = array(
            'message' => 'Assigned Room Deleted Succesfully',
            'alert-type' => 'success'
        );
